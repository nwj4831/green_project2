...
<link rel="stylesheet" href="${pageContext.request.contextPath}/style/rview/rviewrecruitlist.css">
...
<body>
	<div class="section">
		<h2>현재 모집 중인 공고</h2>
		<a class="return" href="rview" style="text-decoration: none;"><button class="return_btn">돌아가기</button></a>
	</div>
