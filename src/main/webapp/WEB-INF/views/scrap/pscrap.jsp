...
<script>
    // DOMContentLoaded 이벤트가 발생한 후에 코드를 실행합니다.
    document.addEventListener('DOMContentLoaded', function() {
        // <div class="Advertisement"> 안에 있는 모든 <a> 태그를 가져옵니다.
        const ads = document.querySelectorAll('.Advertisement > a');
        
        // 랜덤으로 하나의 <a> 태그를 선택합니다.
...
<body>
	<div class="Advertisement_container">
		<div class="Advertisement">
			<a href="https://www.gppc.or.kr/cms/article/view.do?postNo=4448&pageId=K006001002" target="_blank">
				<img src="../../../resources/img/240726_gppc_120_600.png" border="0" alt="AD">
			</a>
			<a href="https://ic.korchamhrd.net/education/professionalSkillEduDetail.do?rootMenuId=3217&menuId=3222&gaebalwon_cd=02000&gwajeong_no=M2024035" target="_blank">
				<img  src="../../../resources/img/240729_harman_120_600.png"" alt="AD">
			</a>
		</div>
	</div>
	<div class="container">
